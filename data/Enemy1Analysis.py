...
plt.title("Enemy 1: Heatmap of Q-Values by Health, Distance, Actions")
plt.xlabel("Action")
...
plt.title("Enemy 1: Heatmap of Q-Values by State and Action")
plt.xlabel("Action")
...
plt.title("Enemy 1: Heatmap of Q-Values by Suppression Fire, Health and Action")
plt.xlabel("Action")
