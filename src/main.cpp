...
int main()
{
    ...
    glm::vec3 playerColor = glm::vec3(0.0f, 0.8f, 0.1f);

    shader.setFloat("playerColorR", playerColor.r);
    shader.setFloat("playerColorG", playerColor.g);
    shader.setFloat("playerColorB", playerColor.b);
