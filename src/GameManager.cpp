...
void GameManager::render()
{
	...
	glm::vec3 newCamFront = camera->Front;
	glm::mat4 camRotate = glm::rotate(camRotate, glm::radians(player->yaw), glm::vec3(0.0f, 1.0f, 0.0f));

	newCamFront = glm::vec3(camRotate * glm::vec4(newCamFront, 1.0f));
